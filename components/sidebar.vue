<template>
  <transition name="sidebar-slide">
    <div
      v-show="isOpen"
      class="absolute right-0 top-0 flex h-full flex-col gap-8 overflow-auto border-l border-l-accent bg-background px-8 pb-16 pt-8 text-black shadow-md md:w-[355px]"
    >
